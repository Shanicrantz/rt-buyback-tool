...
TODAY='2026-09-10'
FRESH={'2026-08-30'}          # refreshed last week — do not re-burn research on these
...
stale=sorted([c for c in byval if c['key'] not in sel and c['cal'] not in FRESH and c['cal']!='2026-08-24'],
