export const meta = {
  name: 'rt-buyback-verify-outliers-2026-09-16',
...
function verifyPrompt(i) {
  return `You are re-verifying outliers from Rajdhani Telecom's weekly buyback refresh. TODAY is 2026-09-16.
...
function refutePrompt(i, v) {
  return `You are an adversarial REFUTER for Rajdhani Telecom. TODAY is 2026-09-16. A verifier just researched these items; assume they are wrong until their numbers survive your checks.
